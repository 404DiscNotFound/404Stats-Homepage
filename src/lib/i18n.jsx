...
const translations = {
  en: {
    ...
    "landing.hero.title1": "Six modules.",
    "landing.hero.title2": "All local.",
    "landing.hero.desc": "404Stats 0.1a tracks blocks, NPC combat, movement, production, interactions, and worlds — all stored in a local H2 database on your Minecraft server. No cloud, no accounts, no external databases.",
    ...
    "landing.carousel.soon": "Coming Soon",
    "landing.carousel.slide1": "Blocks Dashboard",
    "landing.carousel.slide2": "NPC Combat",
    "landing.carousel.slide3": "Movement",
    "landing.carousel.slide4": "Production",
  ...
  de: {
    ...
    "landing.hero.title1": "Sechs Module.",
    "landing.hero.title2": "Komplett lokal.",
    "landing.hero.desc": "404Stats 0.1a trackt Blöcke, NPC-Kampf, Bewegung, Produktion, Interaktionen und Welten — alles in einer lokalen H2-Datenbank auf deinem Minecraft-Server. Keine Cloud, keine Accounts, keine externe Datenbank.",
    "landing.hero.getPlugin": "Download Soon",
    ...
    "landing.carousel.soon": "Coming Soon",
    "landing.carousel.slide1": "Blöcke-Dashboard",
    "landing.carousel.slide2": "NPC-Kampf",
    "landing.carousel.slide3": "Bewegung",
    "landing.carousel.slide4": "Produktion",
