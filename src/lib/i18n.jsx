...
const translations = {
  en: {
    ...
    "landing.features.privacyDesc": "Everything stays on your server. No external tracking, no third-party widgets, no cloud.",
  ...
  de: {
    ...
    "landing.features.privacyDesc": "Alles bleibt auf deinem Server. Kein externes Tracking, keine Drittanbieter-Widgets, keine Cloud.",
