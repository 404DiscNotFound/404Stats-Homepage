  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="mt-1 text-xs text-[#8A8A8A]">{t(img.descKey)}</p>
      </div>
    </button>
  );
}
    ...
    <div className="min-h-screen bg-background text-white overflow-hidden">
      ...
      <nav className="relative z-10 mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-6">
          <Link to="/" className="hidden text-xs text-[#8A8A8A] transition-colors hover:text-white sm:block">{t("gallery.back")}</Link>
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pb-20">
        <Link to="/" className="inline-flex items-center gap-1.5 text-xs text-[#8A8A8A] transition-colors hover:text-[#5BA033]">
          <ArrowLeft className="h-3.5 w-3.5" /> {t("gallery.back")}
        </Link>
        <h1 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">
          {t("gallery.title")}
        </h1>
        <p className="mt-3 max-w-xl text-sm text-[#8A8A8A]">{t("gallery.desc")}</p>
        ...
        <div className="mt-12">
          ...
          <p className="mb-4 max-w-xl text-sm text-[#8A8A8A]">{t("demo.desc")}</p>
