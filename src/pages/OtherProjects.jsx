  ...
  return (
    <div className="min-h-screen bg-background text-white overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pb-20">
        ...
        <p className="mt-3 max-w-xl text-sm text-[#8A8A8A]">{t("projects.page.desc")}</p>

        {/* Pterios Project Card */}
        <div className="mt-10 max-w-3xl overflow-hidden rounded-2xl border border-[#1E1E1F] bg-[#313233] p-6 transition-all hover:border-[#FF8A65]/20 sm:p-8">
