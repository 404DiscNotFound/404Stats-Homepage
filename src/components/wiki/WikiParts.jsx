...
export function WikiArticleHeader({ icon: Icon, accent, title, desc }) {
  return (
    <div className="mb-6 flex items-center gap-3 border-b border-[#1A1A24] pb-4">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-[#1A1A24] bg-[#0F0F14]" style={{ color: accent }}>
