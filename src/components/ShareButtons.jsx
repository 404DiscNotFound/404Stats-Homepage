  ...
  if (compact) {
    return (
      <div className="flex items-center gap-1.5">
        <button onClick={handleNativeShare} title="Share" className={`${btnBase} h-8 w-8 rounded-lg border border-[#1A1A24] bg-[#0A0A0F] text-gray-400 hover:border-[#00F5FF]/30 hover:text-[#00F5FF]`}>
          <Share2 className="h-3.5 w-3.5" />
        </button>
        <button onClick={handleCopy} title="Copy link" className={`${btnBase} h-8 w-8 rounded-lg border border-[#1A1A24] bg-[#0A0A0F] text-gray-400 hover:border-[#00F5FF]/30 hover:text-[#00F5FF]`}>
