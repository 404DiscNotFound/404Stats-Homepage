...
export default function Hero() {
  ...
  return (
    <div className="relative z-10 flex flex-col items-center px-6 pt-12 pb-12 text-center">
      <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#FF0055]/30 bg-[#FF0055]/5 px-4 py-1.5">
        <AlertTriangle className="h-3.5 w-3.5 text-[#FF0055]" />
      ...
      <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row">
        <a href="https://github.com/404DiscNotFound" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-lg border border-[#00F5FF]/30 bg-[#00F5FF]/5 px-6 py-3 text-sm font-bold text-[#00F5FF] transition-all hover:bg-[#00F5FF]/10 hover:shadow-[0_0_25px_rgba(0,245,255,0.15)]">
