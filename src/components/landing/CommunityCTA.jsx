  ...
  return (
    <>
      <div className="relative z-10 mx-auto max-w-3xl px-6 py-16 text-center">
        ...
        <p className="mt-3 max-w-lg mx-auto text-sm text-[#888888]">{t("landing.community.desc")}</p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          {LINKS.map(({ icon: Icon, label, href }) => (
            <a key={label} href={href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-lg border border-[#3D3D3D] bg-[#2E2E2E] px-4 py-2 text-xs font-bold text-gray-400 transition-all hover:border-[#5BA033]/30 hover:text-[#5BA033]">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 py-12">
        <div className="relative overflow-hidden rounded-2xl border border-[#3D3D3D] bg-[#2E2E2E] p-10 text-center">
          ...
          <p className="relative mt-3 text-sm text-[#888888]">{t("landing.cta.desc")}</p>
