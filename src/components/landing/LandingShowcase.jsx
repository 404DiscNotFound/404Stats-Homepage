  ...
  return (
    <div className="relative z-10 mx-auto max-w-5xl px-6 pb-16">
      <div className="grid items-stretch gap-6 lg:grid-cols-[1.4fr_1fr]">
        ...
        <Link
          to="/gallery"
          className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-[#3D3D3D] bg-gradient-to-br from-[#383838] to-[#2E2E2E] p-6 transition-all hover:border-[#5BA033]/30 hover:shadow-[0_0_30px_rgba(91,160,51,0.06)] min-h-[200px]"
        >
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-[#888888]">{t("landing.gallery.desc")}</p>
          </div>
